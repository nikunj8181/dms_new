...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content"><!--Start: First Time Login -->
            <form class="setPForm" id="setPForm" action="<?php echo base_url('login/'); ?>" method="post">
                <div class="alert alert-success">
                    <span><strong>Done! </strong>Password reset successfully! Please login here...</span>
                </div>
                <div class="form-actions">
                    <a href="<?php echo base_url('login/'); ?>" class="btn green uppercase">Login Here</a>
                </div>
            </form> 
