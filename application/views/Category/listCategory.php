                            ...
                            <td> 
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-left" role="menu">
                                        <li>
                                            <a href="javascript:void();" id="<?php echo $cat['id']; ?>" class="callAjax" data-target="#ajax" data-toggle="modal">
                                                <i class="fa fa-pencil"></i> Edit </a>
                                        </li>
                                        <li>
                                            <a onclick="return confirm('Are you sure want to delete?')" href="<?php echo base_url('category/delete/'.$cat['id']); ?>">
...
$(function(){
    ...
    $(".callAjax").on("click", function(){
      var ID = this.id;
      if(ID){
        var url = hiddenUrl+'category/edit/'+ID;
      }else{
        var url = hiddenUrl+'category/add';
      }
      $.ajax({
          type    : 'POST',
          url     : url,
