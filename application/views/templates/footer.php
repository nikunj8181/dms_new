        <!-- BEGIN FOOTER -->
                <p class="copyright-v2"> <?php echo date('Y'); ?> &copy; Excellers Ltd.</p>
        ...
        <script src="<?php echo base_url(); ?>assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="text/javascript"></script>
          <script src="<?php echo base_url(); ?>assets/global/plugins/jstree/dist/jstree.js" type="text/javascript"></script>
        ...
        <!-- Extra Js -->
        <script src="<?php echo base_url(); ?>assets/pages/scripts/mycustom.js" type="text/javascript"></script>
