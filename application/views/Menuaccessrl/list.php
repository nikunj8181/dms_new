            ...
            <div class="col-md-12">
             <?php if($this->session->flashdata('message')){ ?>
              ...
              <!--Start Modal-->
                ...
                <!-- End modal -->
                <!-- FORM LISTING START -->
                <form action="<?php echo base_url('menuaccessrl/listing'); ?>" id="form_PickorderMaster" method="post" enctype="multipart/form-data" class="horizontal-form">
                <div class="portlet box blue">
                    <div class="portlet-title">
                      <div class="caption">
                          <i class="fa fa-filter"></i>Filter User Role
                      </div>
                    </div>
                                      ...
                                      <select class="form-control" name="userRole">
                                        ...
                                        if(isset($userRoleList) && count($userRoleList) > 0){
                                          foreach ($userRoleList as $key => $value){
                                            if($value['alias'] == $selectedRole){
                                              $selected="selected";
                                            }else{
                                              $selected="";
                                            }
                                          ?>
                                            <option value="<?php echo $value['alias']; ?>" <?php echo $selected; ?>><?php echo $value['usertype']; ?></option>
                                          <?php
                                          }
                                        }
                                        ?>
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-list"></i>AccessMenu List
                        </div>
